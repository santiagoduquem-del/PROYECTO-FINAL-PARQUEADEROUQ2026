...
public class ContraseñaLoginGoogleViewController {

    private ContraseñaLoginGoogleController controller = new ContraseñaLoginGoogleController();
    ...
    private void verificarContraseña() {
        ...
        if (controller.verificarContraseña(role, contrasenaIngresada)) {
            ...
            mostrarMensaje("Error", "Acceso denegado", "Contraseña incorrecta para el perfil seleccionado.", Alert.AlertType.ERROR);
        }
    }
