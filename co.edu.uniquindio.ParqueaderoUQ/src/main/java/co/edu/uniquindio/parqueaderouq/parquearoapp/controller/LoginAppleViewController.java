...
public class LoginAppleViewController {

    private LoginAppleController controller = new LoginAppleController();
    ...
    private void verificarAcceso() {
        ...
        if ("ADMIN".equals(role)) {
            ...
            mostrarMensaje("Error", "Autenticación fallida", "La contraseña de Apple ID is incorrecta.", Alert.AlertType.ERROR);
        }
    }
