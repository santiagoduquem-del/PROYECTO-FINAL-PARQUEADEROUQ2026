...
public class ContrasenaLoginMicrosoftController {
    ...
    private void verificarAcceso() {
        ...
        String contrasenaCorrecta = "1224"; // Misma contraseña para consistencia
        ...
        if (contrasena.equals(contrasenaCorrecta)) {
            mostrarMensaje("Éxito", "Autenticación Microsoft", "Acceso concedido exitosamente.", Alert.AlertType.INFORMATION);
            abrirVentanaCliente();
        } else {
            mostrarMensaje("Error", "Autenticación fallida", "La contraseña de Microsoft es incorrecta.", Alert.AlertType.ERROR);
        }
    }
    ...
    @FXML
    void initialize() {
        assert PasswordMicrosoftLogin != null : "fx:id=\"PasswordMicrosoftLogin\" was not injected: check your FXML file 'ContraseñaLoginMicrosoft.fxml'.";
        assert btnPasswordSiguienteMicrosoft != null : "fx:id=\"btnPasswordSiguienteMicrosoft\" was not injected: check your FXML file 'ContraseñaLoginMicrosoft.fxml'.";
